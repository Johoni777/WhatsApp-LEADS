...
export function ChatHeader({ conversation }: ChatHeaderProps) {
  ...
  return (
    <div className="h-[72px] shrink-0 bg-surface-900/80 backdrop-blur-xl border-b border-white/[0.04] px-4 flex items-center justify-between z-10 sticky top-0 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="font-semibold text-white text-base leading-tight cursor-pointer hover:underline">
              ...
              <>
                ...
                <div className="flex gap-1">
                  {contact.tags.slice(0, 2).map((tag, i) => (
                    <span key={i} className="text-[10px] text-text-300 uppercase tracking-wider">
                      {tag}
      ...
      <div className="flex items-center gap-1">
        <button className="p-2.5 text-text-300 hover:text-white hover:bg-surface-800 rounded-xl transition-all">
